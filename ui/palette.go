...
func SetupColors() {
	...
	DarkModePalette = gowid.Palette{
		...
		"title":                     gowid.MakeForeground(gowid.ColorGreen),
		...
		"packet-struct-selected":    gowid.MakePaletteEntry(dfg("packet-struct-selected"), gowid.ColorLightGray),
		...
		"filter-empty":              gowid.MakePaletteEntry(dfg("filter-empty"), dbg("filter-empty")),
		"dialog":                    gowid.MakePaletteEntry(gowid.ColorDefault, gowid.ColorNone),
		"dialog-button":             gowid.MakePaletteEntry(gowid.ColorBlack, gowid.ColorDarkGray),
